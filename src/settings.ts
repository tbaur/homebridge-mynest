...
export const PLUGIN_NAME = 'homebridge-mynest'

/** Platform identifier referenced in the user's Homebridge config. */
export const PLATFORM_NAME = 'MyNest'
 ...
 */
export const GLOBAL_ECO_DISPLAY_NAME = 'Nest Eco Mode'
 ...
 */
export const WEB_APP_VERSION = 'NlAppSDKVersion/8.15.0 NlSchemaVersion/2.1.20-87-gce5742894'
...
const PRODUCTION_ENDPOINTS: NestEndpoints = {
...
const FIELD_TEST_ENDPOINTS: NestEndpoints = {
...
export function resolveEndpoints(isFieldTest: boolean): NestEndpoints {
  return isFieldTest ? FIELD_TEST_ENDPOINTS : PRODUCTION_ENDPOINTS
}

/** Build the `app_launch` URL, which is scoped to one user id. */
export function appLaunchUrl(endpoints: NestEndpoints, userId: string): string {
 ...
 */
export const APP_LAUNCH_BUCKET_TYPES: readonly string[] = [
  'buckets',
  'structure',
  'shared',
  'topaz',
...
export const APP_LAUNCH_TIMEOUT_MS = 120_000
 ...
 */
export const BATCH_UPDATE_TIMEOUT_MS = 30_000
 ...
 */
export const SUBSCRIBE_TIMEOUT_MS = 120_000
 ...
 */
export const SUBSCRIBE_IDLE_MIN_ELAPSED_RATIO = 0.5
 ...
 */
export const REST_ALARM_FEED_STALE_MS = SUBSCRIBE_TIMEOUT_MS + 60_000
 ...
 */
export const REST_PROOF_OF_LIFE_MS = 5 * 60_000
 ...
 */
export const REST_RESPONSE_STALE_MS = REST_PROOF_OF_LIFE_MS + 2 * 60_000
 ...
 */
export const OBSERVE_SESSION_MS = 30 * 60_000

/** Interval between HTTP/2 pings that keep the Observe stream from idling out. */
export const OBSERVE_PING_INTERVAL_MS = 60_000
 ...
 */
export const OBSERVE_PRODUCTIVE_SESSION_MS = 30_000
 ...
 */
export const OBSERVE_CONNECT_TIMEOUT_MS = 30_000
 ...
 */
export const OBSERVE_IDLE_TIMEOUT_MS = 10 * 60_000
 ...
 */
export const MIN_SUBSCRIBE_CYCLE_MS = 2_000
 ...
 */
export const OBSERVE_STARTUP_WARN_MS = 60_000
 ...
 */
export const OBSERVE_SNAPSHOT_SETTLE_MS = 750
 ...
 */
export const OBSERVE_SNAPSHOT_ABANDON_MS = 30_000
 ...
 */
export const FORBIDDEN_FATAL_THRESHOLD = 3
 ...
 * the block.
 */
export const FORBIDDEN_REPROBE_MS = 15 * 60_000
 ...
 */
export const SESSION_REFRESH_MS = 6 * 60 * 60_000
 ...
 */
export const SESSION_EXPIRY_MARGIN_MS = 5 * 60_000
 ...
 */
export const BATCH_UPDATE_MAX_ATTEMPTS = 2
 ...
 */
export const LOOP_FAILURE_WARN_EVERY = 10

/** Interval between operator-visible transport status lines. */
export const STATUS_HEARTBEAT_MS = 15 * 60_000
 ...
 */
export const PROTECT_OCCUPANCY_HOLD_OFF_SEC = 600

/** Floor on the thermostat setpoint HomeKit may request, in Celsius. */
export const MIN_SETPOINT_C = 9
...
export const SETPOINT_STEP_C = 0.5
 ...
 */
export const DEFAULT_SETPOINT_C = 20
 ...
 */
export const DEFAULT_SETPOINT_SPAN_C = 5
 ...
 */
export const MIN_SETPOINT_SPAN_C = 2
...
export const MIN_REPORTED_TEMPERATURE_C = -50

/** Hottest reading treated as real. Matches HomeKit's own ceiling. */
export const MAX_REPORTED_TEMPERATURE_C = 100
 ...
 */
export const REPORTED_TEMPERATURE_STEP_C = 0.1
